#!/usr/bin/env python3
"""
Perfect Qwen extractor built from scratch with correct author parsing and references
"""
...
class PerfectQwenExtractor:
    """Perfect Qwen extractor with correct parsing logic"""
    ...
    def perfect_author_extraction(self, text: str) -> List[Dict[str, Any]]:
        ...
        print("🔍 DEBUG - Perfect Author Extraction (Qwen)")
    ...
    def perfect_funding_extraction(self, text: str) -> List[str]:
        ...
        print("🔍 DEBUG - Perfect Funding Extraction (Qwen)")
    ...
    def extract_references_two_step(self, text: str) -> List[Dict[str, Any]]:
        ...
        print("🔍 DEBUG - Two-Step References Extraction (Qwen)")
...
def main():
    """Test the perfect Qwen extractor"""
    ...
    print("🚀 Testing Perfect Qwen Extractor (From Scratch)")
    print("=" * 60)
    ...
    try:
        ...
        print("🤖 Initializing Qwen 2.5-1.5B model...")
        extractor = PerfectQwenExtractor()
        ...
        results = {
            ...
            "extraction_metadata": {
                ...
                "method": "perfect_qwen_from_scratch",
        ...
        # Save results
        output_path = Path("output/perfect_qwen_from_scratch_results.json")
        ...
        print("✅ Perfect Qwen extractor (from scratch) completed successfully!")
        
    except Exception as e:
        print(f"❌ Perfect Qwen extraction failed: {e}")
        import traceback
        traceback.print_exc()
